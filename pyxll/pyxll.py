...
def xl_macro(signature="", allow_abort=None, arg_descriptions=None):
    """
...
def xl_menu(name, menu=None, sub_menu=None, order=None, sub_order=None, menu_order=None, allow_abort=None):
    """
